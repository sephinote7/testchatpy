...
-- 3) 채팅/요약 저장 (chat_msg)
-- msg_data 구조: { "messages": [ { "type": "chat"|"stt", "speaker": "user"|"assistant", "text": "...", "timestamp": "ISO8601" } ] }
...
CREATE POLICY "chat_msg_update" ON public.chat_msg FOR UPDATE TO authenticated USING (true) WITH CHECK (true);

-- 기존에 summery 컬럼으로 만든 경우: ALTER TABLE public.chat_msg RENAME COLUMN summery TO summary;
